function bsa3(fnc,mydata,popsize,dim,DIM_RATE,low,up,epoch)
...
[fitnesspop,cost]=calculate_total_cost(pop,m,n);
...
%     fitnessoffsprings=feval(fnc,offsprings,mydata);
    [fitnessoffsprings,cost]=calculate_total_cost(offsprings,m,n);
